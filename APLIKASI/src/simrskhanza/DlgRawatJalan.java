...
import static mondrian.olap.fun.LinReg.R2;
...
public final class DlgRawatJalan extends javax.swing.JDialog {
    ...
    public DlgRawatJalan(java.awt.Frame parent, boolean modal) {
        ...
        initComponents();
        initRawatJalan();
        billing = new DlgBilingRalan(null, false); //nampilkan totbiling
    ...
    private void initComponents() {
        ...
        BtnBukaERM = new widget.Button();
        jLabel58 = new widget.Label();
        BtnPemeriksaanRadiologi = new widget.Button();
        BtnPemeriksaanLaborat = new widget.Button();
        ...
        panelGlass12.add(TtlSemua);
        TtlSemua.setBounds(1000, 30, 110, 23);

        jLabel58.setText("Total Biaya :");
        jLabel58.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel58.setName("jLabel58"); // NOI18N
        panelGlass12.add(jLabel58);
        jLabel58.setBounds(910, 30, 80, 23);
        ...
        BtnSimpanSoap.setBounds(910, 70, 200, 30);
        ...
        BtnBukaTemplateSoap.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ...
        BtnBukaTemplateSoap.setBounds(910, 100, 200, 30);
        
        BtnBukaERM.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/PatientFile.png"))); // NOI18N
        BtnBukaERM.setMnemonic('B');
        BtnBukaERM.setText("Buka ERM");
        BtnBukaERM.setToolTipText("Alt+B");
        BtnBukaERM.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnBukaERM.setName("BtnBukaERM"); // NOI18N
        BtnBukaERM.setPreferredSize(new java.awt.Dimension(100, 30));
        BtnBukaERM.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnBukaERMActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnBukaERM);
        BtnBukaERM.setBounds(910, 130, 200, 30);
        
        BtnPemeriksaanRadiologi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/XRay.png")));
        BtnPemeriksaanRadiologi.setMnemonic('S');
        BtnPemeriksaanRadiologi.setText("Riwayat Radiologi");
        BtnPemeriksaanRadiologi.setToolTipText("Alt+S");
        BtnPemeriksaanRadiologi.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnPemeriksaanRadiologi.setMaximumSize(new java.awt.Dimension(172, 26));
        BtnPemeriksaanRadiologi.setMinimumSize(new java.awt.Dimension(172, 26));
        BtnPemeriksaanRadiologi.setName("BtnPemeriksaanRadiologi"); // NOI18N
        BtnPemeriksaanRadiologi.setPreferredSize(new java.awt.Dimension(100, 30));
        BtnPemeriksaanRadiologi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnPemeriksaanRadiologiActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnPemeriksaanRadiologi);
        BtnPemeriksaanRadiologi.setBounds(910, 160, 200, 30);
        
        BtnPemeriksaanLaborat.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/TestTubes.png")));
        BtnPemeriksaanLaborat.setMnemonic('S');
        BtnPemeriksaanLaborat.setText("Riwayat Laborat");
        BtnPemeriksaanLaborat.setToolTipText("Alt+S");
        BtnPemeriksaanLaborat.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnPemeriksaanLaborat.setName("BtnPemeriksaanLaborat"); // NOI18N
        BtnPemeriksaanLaborat.setPreferredSize(new java.awt.Dimension(100, 30));
        BtnPemeriksaanLaborat.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnPemeriksaanLaboratActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnPemeriksaanLaborat);
        BtnPemeriksaanLaborat.setBounds(910, 190, 200, 30);
        ...
        internalFrame12.add(panelGlass5, java.awt.BorderLayout.PAGE_END);

        TabRawat.addTab("Riwayat SOAPI", internalFrame12);
        ...
        BtnCasmix.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnCasmix.setText("Riwayat Ralan Casmix");
        BtnCasmix.setFocusPainted(false);
        BtnCasmix.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnCasmix.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnCasmix.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnCasmix.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnCasmix.setName("BtnCasmix"); // NOI18N
        BtnCasmix.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnCasmix.setRoundRect(false);
        BtnCasmix.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnCasmixActionPerformed(evt);
            }
        });
        FormMenu.add(BtnCasmix);
            ...
            case 3:
                if(tabModePemeriksaan.getRowCount()==0){
                    ...
                    Valid.MyReportqry("rptJalanPemeriksaan.jasper","report","::[ Data Pemeriksaan Rawat Jalan ]::",
                            "select pemeriksaan_ralan.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,DATE_FORMAT(pasien.tgl_lahir,'%d-%m-%Y')as tgl_lahir, "+
                            "pemeriksaan_ralan.tgl_perawatan,pemeriksaan_ralan.jam_rawat,pemeriksaan_ralan.suhu_tubuh,pemeriksaan_ralan.tensi, " +
                            "pemeriksaan_ralan.nadi,pemeriksaan_ralan.respirasi,pemeriksaan_ralan.tinggi,pasien.jk, " +
...
private void BtnEditKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnEditKeyPressed
    ...
    try {
        ...
        if (billing == null) {
            ...
            billing.setNoRm(TNoRw.getText(), TNoRM.getText(), TPasien.getText());
            billing.isCek(); 
            billing.isRawat();
            String totalFormatted = billing.getFormattedTotalTagihan();
            TtlSemua.setText(totalFormatted);
        } catch (Exception e) {
            e.printStackTrace();
            TtlSemua.setText("0");
        } 
    ...
    private void BtnSimpanSoapActionPerformed(java.awt.event.ActionEvent evt) {                                              
        if(TKeluhan.getText().trim().equals("")){
            ...
            Valid.textKosong(TInstruksi,"Intruksi");
        }else if(TEvaluasi.getText().trim().equals("")){
            Valid.textKosong(TEvaluasi,"Evaluasi");
        }else{
            Sequel.menyimpan("template_soap","'0','"+TKeluhan.getText()+"','"+TPemeriksaan.getText()+"','"+TPenilaian.getText()+"','"+TindakLanjut.getText()+"','"+TInstruksi.getText()+"','"+TEvaluasi.getText()+"'","Template Soap");
            JOptionPane.showMessageDialog(null,"Template SOAP Sukses di Simpan");

        }
    }
    
    private void BtnBukaTemplateSoapActionPerformed(java.awt.event.ActionEvent evt) {                                                    
        akses.setform("DlgRawatJalan");
        soap.isCek();
        soap.setSize(internalFrame1.getWidth()-10,internalFrame1.getHeight()-10);
        soap.setLocationRelativeTo(internalFrame1);
        soap.setVisible(true);
    }
    
    private void BtnBukaERMActionPerformed(java.awt.event.ActionEvent evt) {                                           
        if(TNoRw.getText().trim().equals("") ){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        } else {
            ...
            DlgERMRalan form = new DlgERMRalan(null, false);
    ...
    private void BtnPemeriksaanRadiologiActionPerformed(java.awt.event.ActionEvent evt) {                                                        
        // TODO add your handling code here:
        if(TNoRM.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Silahkan pilih pasien terlebih dahulu");
        } else {
            RMRiwayatPerawatan history = new RMRiwayatPerawatan(null, false);
            history.setCekOtomatis(TNoRM.getText(), true, false);       
            history.setSize(this.getWidth(), this.getHeight());
            history.setLocationRelativeTo(this);
            history.setVisible(true);
        }
    }
    
    private void BtnPemeriksaanLaboratActionPerformed(java.awt.event.ActionEvent evt) {                                                      
        // TODO add your handling code here:
        if(TNoRM.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Silahkan pilih pasien terlebih dahulu");
        } else {
            RMRiwayatPerawatan history = new RMRiwayatPerawatan(null, false);
            history.setCekOtomatis(TNoRM.getText(), false, true); 
            history.setSize(this.getWidth(), this.getHeight());
            history.setLocationRelativeTo(this);
            history.setVisible(true);
        }
    ...
    private void BtnCasmixActionPerformed(java.awt.event.ActionEvent evt) {                                          
        if(TNoRM.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Silahkan pilih pasien terlebih dahulu");
        } else {
            RMRiwayatPerawatan history = new RMRiwayatPerawatan(null, false);
            history.setCekRalan(TNoRM.getText(), true, true, true, true, true, true, true, true, true);       
            history.setSize(this.getWidth(), this.getHeight());
            history.setLocationRelativeTo(this);
            history.setVisible(true);
        }
    ...
    */
    ...
    private widget.Button BtnBukaERM;
    ...
    private widget.Button BtnPemeriksaanLaborat;
    private widget.Button BtnPemeriksaanRadiologi;
    ...
    private widget.Button BtnCasmix;
    ...
    private widget.Button BtnSkorBromagePascaAnestesi,BtnPenilaianPreInduksi,BtnHasilPemeriksaanUSGUrologi,BtnHasilPemeriksaanUSGGynecologi,BtnHasilPemeriksaanEKG,BtnPenatalaksanaanTerapiOkupasi,BtnPenilaianPsikolog,
                          ...
                          BtnHasilPemeriksaanTreadmill,BtnHasilPemeriksaanECHOPediatrik,BtnSkriningCURB65,BtnPermintaanKonsultasiPerawat;   
    ...
    try {
      ...
      this.htmlContent.append("<tr class='isi'><td valign='middle' bgcolor='#FFFAF8' align='center' width='5%'>Tgl.Reg</td><td valign='middle' bgcolor='#FFFAF8' align='center' width='8%'>No.Rawat</td><td valign='middle' bgcolor='#FFFAF8' align='center' width='3%'>Status</td><td valign='middle' bgcolor='#FFFAF8' align='center' width='84%'>S.O.A.P.I.E</td></tr>");
      if (this.R1.isSelected() == true) {
        this.ps = this.koneksi.prepareStatement("select reg_periksa.no_reg,reg_periksa.no_rawat,reg_periksa.tgl_registrasi,reg_periksa.status_lanjut from reg_periksa where reg_periksa.stts<>'Batal' and reg_periksa.no_rkm_medis=? order by reg_periksa.tgl_registrasi desc limit 5");
      } else if (this.R2.isSelected() == true) {
        this.ps = this.koneksi.prepareStatement("select reg_periksa.no_reg,reg_periksa.no_rawat,reg_periksa.tgl_registrasi,reg_periksa.status_lanjut from reg_periksa where reg_periksa.stts<>'Batal' and reg_periksa.no_rkm_medis=? order by reg_periksa.tgl_registrasi");
      } else if (this.R3.isSelected() == true) {
        this.ps = this.koneksi.prepareStatement("select reg_periksa.no_reg,reg_periksa.no_rawat,reg_periksa.tgl_registrasi,reg_periksa.status_lanjut from reg_periksa where reg_periksa.stts<>'Batal' and reg_periksa.no_rkm_medis=? and reg_periksa.tgl_registrasi between ? and ? order by reg_periksa.tgl_registrasi");
      } else if (this.R4.isSelected() == true) {
        this.ps = this.koneksi.prepareStatement("select reg_periksa.no_reg,reg_periksa.no_rawat,reg_periksa.tgl_registrasi,reg_periksa.status_lanjut from reg_periksa where reg_periksa.stts<>'Batal' and reg_periksa.no_rkm_medis=? and reg_periksa.no_rawat=?");
      } 
      try {
        if (this.R1.isSelected() == true) {
          this.ps.setString(1, this.TNoRM.getText().trim());
        } else if (this.R2.isSelected() == true) {
          this.ps.setString(1, this.TNoRM.getText().trim());
        } else if (this.R3.isSelected() == true) {
          this.ps.setString(1, this.TNoRM.getText().trim());
          this.ps.setString(2, this.Valid.SetTgl(this.Tgl1.getSelectedItem() + ""));
          this.ps.setString(3, this.Valid.SetTgl(this.Tgl2.getSelectedItem() + ""));
        } else if (this.R4.isSelected() == true) {
          this.ps.setString(1, this.TNoRM.getText().trim());
          this.ps.setString(2, this.NoRawat.getText().trim());
        } 
        this.rs = this.ps.executeQuery();
        while (this.rs.next()) {
          this.htmlContent.append("<tr class='isi'><td valign='top' align='center'>" + this.rs
              
              .getString("tgl_registrasi") + "</td><td valign='top' align='center'>" + this.rs
              .getString("no_rawat") + "</td><td valign='top' align='center'>" + this.rs
              .getString("status_lanjut") + "</td><td valign='top' align='center'><table width='100%' border='0' align='center' cellpadding='2px' cellspacing='0'>");
          try {
            this
              
              .rs2 = this.koneksi.prepareStatement("select pemeriksaan_ralan.tgl_perawatan,pemeriksaan_ralan.jam_rawat,pemeriksaan_ralan.suhu_tubuh,pemeriksaan_ralan.tensi,pemeriksaan_ralan.nadi,pemeriksaan_ralan.respirasi,pemeriksaan_ralan.tinggi,pemeriksaan_ralan.berat,pemeriksaan_ralan.gcs,pemeriksaan_ralan.spo2,pemeriksaan_ralan.kesadaran,pemeriksaan_ralan.keluhan, pemeriksaan_ralan.pemeriksaan,pemeriksaan_ralan.alergi,pemeriksaan_ralan.lingkar_perut,pemeriksaan_ralan.rtl,pemeriksaan_ralan.penilaian,pemeriksaan_ralan.instruksi,pemeriksaan_ralan.evaluasi,pemeriksaan_ralan.nip,pegawai.nama,pegawai.jbtn from pemeriksaan_ralan inner join pegawai on pemeriksaan_ralan.nip=pegawai.nik where pemeriksaan_ralan.no_rawat='" + this.rs.getString("no_rawat") + "' order by pemeriksaan_ralan.tgl_perawatan,pemeriksaan_ralan.jam_rawat").executeQuery();
            if (this.rs2.next()) {
              this.htmlContent.append("<tr class='isi'><td valign='middle' bgcolor='#FFFFF8' align='center' width='7%'>Tanggal</td><td valign='middle' bgcolor='#FFFFF8' align='center' width='13%'>Dokter/Paramedis</td><td valign='middle' bgcolor='#FFFFF8' align='center' width='14%'>Subjek</td><td valign='middle' bgcolor='#FFFFF8' align='center' width='13%'>Objek</td><td valign='middle' bgcolor='#FFFFF8' align='center' width='13%'>Asesmen</td><td valign='middle' bgcolor='#FFFFF8' align='center' width='14%'>Plan</td><td valign='middle' bgcolor='#FFFFF8' align='center' width='14%'>Instruksi</td><td valign='middle' bgcolor='#FFFFF8' align='center' width='14%'>Evaluasi</td></tr>");
              this.rs2.beforeFirst();
              while (this.rs2.next())
                this.htmlContent.append("<tr class='isi'><td align='center'>" + this.rs2
                    
                    .getString("tgl_perawatan") + "<br>" + this.rs2.getString("jam_rawat") + "</td><td align='center'>" + this.rs2
                    .getString("nip") + "<br>" + this.rs2.getString("nama") + "</td><td align='left'>" + this.rs2
                    .getString("keluhan").replaceAll("<", "&lt;").replaceAll(">", "&gt;").replaceAll("(\r\n|\r|\n|\n\r)", "<br>") + "</td><td align='left'>" + this.rs2
                    .getString("pemeriksaan").replaceAll("<", "&lt;").replaceAll(">", "&gt;").replaceAll("(\r\n|\r|\n|\n\r)", "<br>") + (
                    this.rs2.getString("alergi").equals("") ? "" : ("<br>Alergi : " + this.rs2.getString("alergi"))) + (
                    this.rs2.getString("suhu_tubuh").equals("") ? "" : ("<br>Suhu(C) : " + this.rs2.getString("suhu_tubuh"))) + (
                    this.rs2.getString("tensi").equals("") ? "" : ("<br>Tensi : " + this.rs2.getString("tensi"))) + (
                    this.rs2.getString("nadi").equals("") ? "" : ("<br>Nadi(/menit) : " + this.rs2.getString("nadi"))) + (
                    this.rs2.getString("respirasi").equals("") ? "" : ("<br>Respirasi(/menit) : " + this.rs2.getString("respirasi"))) + (
                    this.rs2.getString("tinggi").equals("") ? "" : ("<br>Tinggi(Cm) : " + this.rs2.getString("tinggi"))) + (
                    this.rs2.getString("berat").equals("") ? "" : ("<br>Berat(Kg) : " + this.rs2.getString("berat"))) + (
                    this.rs2.getString("lingkar_perut").equals("") ? "" : ("<br>Lingkar Perut(Cm) : " + this.rs2.getString("lingkar_perut"))) + (
                    this.rs2.getString("spo2").equals("") ? "" : ("<br>SpO2(%) : " + this.rs2.getString("spo2"))) + (
                    this.rs2.getString("gcs").equals("") ? "" : ("<br>GCS(E,V,M) : " + this.rs2.getString("gcs"))) + (
                    this.rs2.getString("kesadaran").equals("") ? "" : ("<br>Kesadaran : " + this.rs2.getString("kesadaran"))) + "</td><td align='left'>" + this.rs2
                    
                    .getString("penilaian").replaceAll("(\r\n|\r|\n|\n\r)", "<br>") + "</td><td align='left'>" + this.rs2
                    .getString("rtl").replaceAll("(\r\n|\r|\n|\n\r)", "<br>") + "</td><td align='left'>" + this.rs2
                    .getString("instruksi").replaceAll("(\r\n|\r|\n|\n\r)", "<br>") + "</td><td align='left'>" + this.rs2
                    .getString("evaluasi").replaceAll("(\r\n|\r|\n|\n\r)", "<br>") + "</td></tr>"); 
            } 
          } catch (Exception e) {
            System.out.println("Notifikasi : " + e);
          } finally {
          ...
          this.htmlContent.append("</table></td></tr>");
        } 
      } catch (Exception e) {
        System.out.println("Notif : " + e);
      } finally {
      ...
      this.LoadHTMLSOAPI.setText("<html><table width='100%' border='0' align='center' cellpadding='3px' cellspacing='0' class='tbl_form'>" + this.htmlContent
