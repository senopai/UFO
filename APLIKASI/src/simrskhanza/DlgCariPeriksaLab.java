                    ...
                    while (rs.next()) {
                        ...
                        try {
                            ...
                            if (rspermintaan.next()) {
                                ...
                                Valid.MyReportPDFUpload("rptPeriksaLab2Permintaan.jasper", "report", "::[ Pemeriksaan Laboratorium ]::", FileName, param);
                            } else {
                                //Valid.MyReport("rptPeriksaLab9.jasper", "report", "::[ Pemeriksaan Laboratorium ]::", param);
                                //Valid.MyReportPDFUpload("rptBridgingSEP2.jasper", "report", "::[ Cetak SEP ]::", FileName, param);
                                Valid.MyReportPDFUpload("rptPeriksaLab2.jasper", "report", "::[ Pemeriksaan Laboratorium ]::", FileName, param);
                            }
                        } catch (Exception e) {
                            System.out.println("Notif : " + e);
                        } finally {
