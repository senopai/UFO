...
public class DlgBookingOperasi extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        DTPCari3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "10-10-2025" }));
        ...
        DTPCari4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "10-10-2025" }));
        ...
        Status.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Menunggu", "Proses Operasi", "Selesai", "Dijadwalkan" }));
  ...
  isForm();                
    ...
    */
    ...
    public void tampil() {     
        ...
        }else if (this.R5.isSelected() == true) {
            status = " booking_operasi.status='Dijadwalkan' ";
        } 
