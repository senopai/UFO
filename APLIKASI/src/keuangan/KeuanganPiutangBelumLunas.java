...
public final class KeuanganPiutangBelumLunas extends javax.swing.JDialog {
    ...
    private void tbBangsalKeyPressed(java.awt.event.KeyEvent evt) {                                     
        if(tabMode.getRowCount()!=0){
...
private void MnDetailPiutangActionPerformed(java.awt.event.ActionEvent evt) {                                                
    if(tabMode.getRowCount()==0){
    ...
    private void BtnBayarKeyPressed(java.awt.event.KeyEvent evt) {                                    
        // TODO add your handling code here:
    }                                   

    private void AkunBayarKeyPressed(java.awt.event.KeyEvent evt) {                                     
    ...
    private void tbBangsalMouseClicked(java.awt.event.MouseEvent evt) {                                       
        if(tabMode.getRowCount()!=0){
    ...
    private void tbBangsalPropertyChange(java.beans.PropertyChangeEvent evt) {                                         
    ...
    private void ppKapitasiPaketActionPerformed(java.awt.event.ActionEvent evt) {                                                
        if(kdpenjab.getText().equals("")||nmpenjab.getText().equals("")){
            JOptionPane.showMessageDialog(null,"Silahkan pilih cara bayar terlebih dahulu");
        }else if(tabMode.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong...!!!!");
    ...
    private void BtnCloseHitungKapitasiActionPerformed(java.awt.event.ActionEvent evt) {                                                       
        WindowHitungPaket.dispose();
    }                                                      

    private void BtnHitungKapitasiActionPerformed(java.awt.event.ActionEvent evt) {                                                  
        try {
    ...
    private void NilaiKapitasiPaketKeyPressed(java.awt.event.KeyEvent evt) {                                              
