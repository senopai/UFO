...
public final class RMTransferPasienAntarRuang extends javax.swing.JDialog {
    ...
    public RMTransferPasienAntarRuang(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "Keluhan Utama Sebelum Transfer","Intruksi","Keadaan Umum StT","TD StT","Nadi StT","RR StT","Suhu Stt","Keluhan Utama Setelah Transfer","NIP Menyerahkan",
        ...
        KeluhanUtamaSebelumTransfer.setDocument(new batasInput((int)800).getKata(KeluhanUtamaSebelumTransfer));
        Intruksi.setDocument(new batasInput((int)800).getKata(Intruksi));
        ...
        KeluhanUtamaSetelahTransfer.setDocument(new batasInput((int)800).getKata(KeluhanUtamaSetelahTransfer));
    ...
    private void initComponents() {
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(16000, 900));
        ...
        TanggalMasuk.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "18-02-2025 13:43:28" }));
        ...
        TanggalPindah.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "18-02-2025 13:43:28" }));
        ...
        jLabel41.setText("Intruksi / Catatan Penting :");
        jLabel41.setName("jLabel41"); // NOI18N
        FormInput.add(jLabel41);
        jLabel41.setBounds(10, 510, 170, 23);
        ...
        scrollPane5.setBounds(450, 430, 400, 60);
        ...
        jLabel43.setBounds(10, 620, 320, 23);

        jLabel44.setText("Keadaan Umum :");
        jLabel44.setName("jLabel44"); // NOI18N
        FormInput.add(jLabel44);
        jLabel44.setBounds(40, 640, 90, 23);
        ...
        KeadaanUmumSetelahTransfer.setBounds(140, 640, 130, 23);

        jLabel29.setText("TD :");
        jLabel29.setName("jLabel29"); // NOI18N
        FormInput.add(jLabel29);
        jLabel29.setBounds(280, 640, 30, 23);
        ...
        TDSetelahTransfer.setBounds(310, 640, 60, 23);

        jLabel45.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel45.setText("mmHg");
        jLabel45.setName("jLabel45"); // NOI18N
        FormInput.add(jLabel45);
        jLabel45.setBounds(380, 640, 50, 23);

        jLabel46.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel46.setText("Keluhan Utama :");
        jLabel46.setName("jLabel46"); // NOI18N
        FormInput.add(jLabel46);
        jLabel46.setBounds(440, 640, 170, 23);
        ...
        scrollPane6.setBounds(440, 660, 410, 63);

        jLabel47.setText("Nadi :");
        jLabel47.setName("jLabel47"); // NOI18N
        FormInput.add(jLabel47);
        jLabel47.setBounds(40, 670, 90, 23);
        ...
        NadiSetelahTransfer.setBounds(140, 670, 60, 23);

        jLabel48.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel48.setText("x/menit");
        jLabel48.setName("jLabel48"); // NOI18N
        FormInput.add(jLabel48);
        jLabel48.setBounds(200, 670, 50, 23);

        jLabel49.setText("RR :");
        jLabel49.setName("jLabel49"); // NOI18N
        FormInput.add(jLabel49);
        jLabel49.setBounds(280, 670, 30, 23);
        ...
        RRSetelahTransfer.setBounds(310, 670, 60, 23);

        jLabel50.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel50.setText("x/menit");
        jLabel50.setName("jLabel50"); // NOI18N
        FormInput.add(jLabel50);
        jLabel50.setBounds(380, 670, 50, 23);

        jLabel51.setText("Suhu :");
        jLabel51.setName("jLabel51"); // NOI18N
        FormInput.add(jLabel51);
        jLabel51.setBounds(40, 700, 90, 23);
        ...
        SuhuSetelahTransfer.setBounds(140, 700, 60, 23);

        jLabel52.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel52.setText("°C");
        jLabel52.setName("jLabel52"); // NOI18N
        FormInput.add(jLabel52);
        jLabel52.setBounds(200, 700, 30, 23);
        ...
        label14.setBounds(10, 740, 130, 23);
        ...
        KdPetugasMenyerahkan.setBounds(130, 760, 100, 23);
        ...
        NmPetugasMenyerahkan.setBounds(230, 760, 180, 23);
        ...
        BtnDokter.setBounds(420, 760, 28, 23);

        label15.setText("Menerima :");
        label15.setName("label15"); // NOI18N
        label15.setPreferredSize(new java.awt.Dimension(70, 23));
        FormInput.add(label15);
        label15.setBounds(460, 760, 70, 23);
        ...
        KdPetugasMenerima.setBounds(540, 760, 100, 23);
        ...
        NmPetugasMenerima.setBounds(640, 760, 180, 23);
        ...
        BtnMenerima.setBounds(820, 760, 28, 23);

        label16.setText("Menyerahkan :");
        label16.setName("label16"); // NOI18N
        label16.setPreferredSize(new java.awt.Dimension(70, 23));
        FormInput.add(label16);
        label16.setBounds(40, 760, 90, 23);

        jLabel53.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel53.setText("Keluhan Utama :");
        jLabel53.setName("jLabel53"); // NOI18N
        FormInput.add(jLabel53);
        jLabel53.setBounds(445, 410, 170, 23);

        scrollPane7.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        scrollPane7.setName("scrollPane7"); // NOI18N

        Intruksi.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        Intruksi.setColumns(20);
        Intruksi.setRows(5);
        ...
        scrollPane7.setViewportView(Intruksi);

        FormInput.add(scrollPane7);
        scrollPane7.setBounds(20, 530, 410, 63);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        }else if(Intruksi.getText().trim().equals("")){
            Valid.textKosong(Intruksi,"Intruksi");
            ...
            try{
                if(TCari.getText().trim().equals("")){
                    ps=koneksi.prepareStatement(
                            ...
                            "transfer_pasien_antar_ruang.keluhan_utama_sebelum_transfer,transfer_pasien_antar_ruang.intruksi,transfer_pasien_antar_ruang.keadaan_umum_sebelum_transfer,"+
                    ...
                    htmlContent.append(                             
                        "<tr class='isi'>"+
                           "<td valign='middle' bgcolor='#FFFAF8' align='center'><b>No.Rawat</b></td>"+
                            ...
                            "<td valign='middle' bgcolor='#FFFAF8' align='center'><b>Intruksi</b></td>"+
                    ...
                    while(rs.next()){
                        htmlContent.append(
                            "<tr class='isi'>"+
                               ...
                               "<td valign='top'>"+rs.getString("intruksi")+"</td>"+
    ...
    private void KeluhanUtamaSebelumTransferKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KeluhanUtamaSebelumTransferKeyPressed
        Valid.pindah2(evt,SuhuSebelumTransfer,Intruksi);
    ...
    private void KeadaanUmumSetelahTransferKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KeadaanUmumSetelahTransferKeyPressed
        Valid.pindah(evt,Intruksi,TDSetelahTransfer);
    ...
    private void IntruksiKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_IntruksiKeyPressed
        Valid.pindah2(evt,KeluhanUtamaSebelumTransfer,KeadaanUmumSetelahTransfer);
    ...
    private void BtnPrint1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint1ActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            param.put("finger","Dikeluarkan di "+akses.getnamars()+", Kabupaten/Kota "+akses.getkabupatenrs()+"\nDitandatangani secara elektronik oleh "+tbObat.getValueAt(tbObat.getSelectedRow(),38).toString()+"\nID "+(finger.equals("")?tbObat.getValueAt(tbObat.getSelectedRow(),38   ).toString():finger)+"\n"+Valid.SetTgl3(tbObat.getValueAt(tbObat.getSelectedRow(),8).toString()));
            Valid.MyReportqry("rptTransferPasien.jasper","report","::[ Laporan Transfer Pasien ]::",
                "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,transfer_pasien_antar_ruang.tanggal_masuk,transfer_pasien_antar_ruang.tanggal_pindah, "+
                "transfer_pasien_antar_ruang.asal_ruang,transfer_pasien_antar_ruang.ruang_selanjutnya,transfer_pasien_antar_ruang.diagnosa_utama,transfer_pasien_antar_ruang.diagnosa_sekunder,transfer_pasien_antar_ruang.indikasi_pindah_ruang, "+
                "transfer_pasien_antar_ruang.keterangan_indikasi_pindah_ruang,transfer_pasien_antar_ruang.prosedur_yang_sudah_dilakukan,transfer_pasien_antar_ruang.obat_yang_telah_diberikan,transfer_pasien_antar_ruang.metode_pemindahan_pasien, " +
                "transfer_pasien_antar_ruang.peralatan_yang_menyertai,transfer_pasien_antar_ruang.keterangan_peralatan_yang_menyertai,transfer_pasien_antar_ruang.pemeriksaan_penunjang_yang_dilakukan,transfer_pasien_antar_ruang.pasien_keluarga_menyetujui, "+
                "transfer_pasien_antar_ruang.nama_menyetujui,transfer_pasien_antar_ruang.hubungan_menyetujui,transfer_pasien_antar_ruang.keluhan_utama_sebelum_transfer,transfer_pasien_antar_ruang.intruksi,transfer_pasien_antar_ruang.keadaan_umum_sebelum_transfer, "+
                "transfer_pasien_antar_ruang.td_sebelum_transfer,transfer_pasien_antar_ruang.nadi_sebelum_transfer,transfer_pasien_antar_ruang.rr_sebelum_transfer,transfer_pasien_antar_ruang.suhu_sebelum_transfer, "+
                "transfer_pasien_antar_ruang.keluhan_utama_sesudah_transfer,transfer_pasien_antar_ruang.keadaan_umum_sesudah_transfer,transfer_pasien_antar_ruang.td_sesudah_transfer,transfer_pasien_antar_ruang.nadi_sesudah_transfer,transfer_pasien_antar_ruang.rr_sesudah_transfer,transfer_pasien_antar_ruang.suhu_sesudah_transfer, "+
                "transfer_pasien_antar_ruang.nip_menyerahkan,transfer_pasien_antar_ruang.nip_menerima, "+
                "petugasmenyerahkan.nama as petugasmenyerahkan,petugasmenerima.nama as petugasmenerima "+
                "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                "inner join transfer_pasien_antar_ruang on reg_periksa.no_rawat=transfer_pasien_antar_ruang.no_rawat "+
                "inner join petugas as petugasmenyerahkan on transfer_pasien_antar_ruang.nip_menyerahkan=petugasmenyerahkan.nip "+
                "inner join petugas as petugasmenerima on transfer_pasien_antar_ruang.nip_menerima=petugasmenerima.nip where transfer_pasien_antar_ruang.no_rawat='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"'and transfer_pasien_antar_ruang.asal_ruang='"+tbObat.getValueAt(tbObat.getSelectedRow(),9).toString()+"' and transfer_pasien_antar_ruang.ruang_selanjutnya='"+tbObat.getValueAt(tbObat.getSelectedRow(),10).toString()+"'",param);
        }else{
    ...
    */
    ...
    private widget.TextArea Intruksi;
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("rr_sebelum_transfer"),rs.getString("suhu_sebelum_transfer"),rs.getString("keluhan_utama_sebelum_transfer"),rs.getString("intruksi"),rs.getString("keadaan_umum_sesudah_transfer"),
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            Intruksi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),28).toString());
    ...
    private void ganti() {
        if(Sequel.mengedittf("transfer_pasien_antar_ruang","no_rawat=? and tanggal_masuk=?","no_rawat=?,tanggal_masuk=?,tanggal_pindah=?,asal_ruang=?,ruang_selanjutnya=?,diagnosa_utama=?,"+
                ...
                "keluhan_utama_sebelum_transfer=?,intruksi=?,keadaan_umum_sebelum_transfer=?,td_sebelum_transfer=?,nadi_sebelum_transfer=?,rr_sebelum_transfer=?,suhu_sebelum_transfer=?,"+
                ...
                HubunganMenyetujui.getSelectedItem().toString(),KeluhanUtamaSebelumTransfer.getText(),Intruksi.getText(),KeadaanUmumSebelumTransfer.getSelectedItem().toString(),
                ...
                tbObat.setValueAt(Intruksi.getText(),tbObat.getSelectedRow(),28);
                ...
                tbObat.setValueAt(NmPetugasMenyerahkan.getText(),tbObat.getSelectedRow(),36);
                tbObat.setValueAt(KdPetugasMenerima.getText(),tbObat.getSelectedRow(),37);
                tbObat.setValueAt(NmPetugasMenerima.getText(),tbObat.getSelectedRow(),38);
                emptTeks();
                TabRawat.setSelectedIndex(1);
        }
    }
