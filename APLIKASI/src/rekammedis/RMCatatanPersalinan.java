...
public final class RMCatatanPersalinan extends javax.swing.JDialog {
    ...
    private String FileName = "", kodeberkas = "";
    ...
    private void initComponents() {
        ...
        UploadCatatanPersalinan = new javax.swing.JMenuItem();
        ...
        UploadCatatanPersalinan.setBackground(new java.awt.Color(255, 255, 254));
        UploadCatatanPersalinan.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        UploadCatatanPersalinan.setForeground(new java.awt.Color(50, 50, 50));
        UploadCatatanPersalinan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        UploadCatatanPersalinan.setText("Upload Berkas");
        UploadCatatanPersalinan.setName("UploadCatatanPersalinan"); // NOI18N
        UploadCatatanPersalinan.setPreferredSize(new java.awt.Dimension(240, 26));
        UploadCatatanPersalinan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                UploadCatatanPersalinanActionPerformed(evt);
            }
        });
        jPopupMenu1.add(UploadCatatanPersalinan);
        ...
        WaktuSelesai.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "07-01-2026 10:44:02" }));
        ...
        WaktuMulai.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "07-01-2026 10:44:03" }));
    ...
    private void UploadCatatanPersalinanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UploadCatatanPersalinanActionPerformed
        FileName = "PERSALINAN_" + tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString().replaceAll("/", "") + "_" + tbObat.getValueAt(tbObat.getSelectedRow(), 1).toString().trim() + "_" + tbObat.getValueAt(tbObat.getSelectedRow(), 2).toString().replaceAll(" ", "_");
        CreatePDF(FileName);
        String filePath = "tmpPDF/" + FileName;
        UploadPDF(FileName, "berkasrawat/pages/upload/");
        HapusPDF();
    }//GEN-LAST:event_UploadCatatanPersalinanActionPerformed
    ...
    private void CreatePDF(String FileName) {
        ...
        // Query SQL
        String query = "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,catatan_persalinan.mulai," +
                "catatan_persalinan.selesai,catatan_persalinan.kd_dokter,catatan_persalinan.nip,catatan_persalinan.catatan,catatan_persalinan.waktu_persalinan_kala_1," +
                "catatan_persalinan.waktu_persalinan_kala_2,catatan_persalinan.waktu_persalinan_kala_3,catatan_persalinan.waktu_persalinan_jumlah,catatan_persalinan.perineum," +
                "catatan_persalinan.jahitan_luar_1,catatan_persalinan.jahitan_luar_2,catatan_persalinan.jahitan_dalam_1,catatan_persalinan.jahitan_dalam_2,catatan_persalinan.anak," +
                "catatan_persalinan.status_lahir,catatan_persalinan.apgar_score,catatan_persalinan.bb,catatan_persalinan.pb,catatan_persalinan.kelainan,catatan_persalinan.ketuban," +
        ...
        // PERBAIKAN DISINI: Sesuaikan nama fungsi dengan yang ada di validasi.java (PDFqryUpload)
        Valid.MyReportPDFqryUpload("rptCetakCatatanPersalinan.jasper", "report", "::[ Laporan Catatan Persalinan ]::", query, FileName, param);
    ...
    private void UploadPDF(String FileName, String docpath) {
        try {
            ...
            kodeberkas = Sequel.cariIsi("SELECT kode FROM master_berkas_digital WHERE nama LIKE '%PERSALINAN%'");
            if (Sequel.cariInteger("SELECT COUNT(no_rawat) FROM berkas_digital_perawatan WHERE no_rawat='" + tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString() + "' AND kode='" + kodeberkas + "'") > 0) {
                
                // Jika sudah ada, Update data
                uploadSuccess = Sequel.mengedittf("berkas_digital_perawatan", "lokasi_file=?", "no_rawat=? AND kode=?", 3, new String[]{
                ...
                uploadSuccess = Sequel.menyimpantf("berkas_digital_perawatan", "?,?,?", "Berkas Digital", 3, new String[]{
                    tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString(),
                    kodeberkas,
                    "pages/upload/" + FileName + ".pdf"
                });
    ...
    */
    ...
    private javax.swing.JMenuItem UploadCatatanPersalinan;
