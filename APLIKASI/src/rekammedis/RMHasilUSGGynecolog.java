 ...
 * @author perpustakaan
 */
public final class RMHasilUSGGynecolog extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMHasilUSGGynecolog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel45.setBounds(0, 120, 85, 23);
        ...
        cmbUterus.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmbUterusActionPerformed(evt);
            }
        });
        FormInput.add(cmbUterus);
        cmbUterus.setBounds(100, 120, 120, 22);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMHasilUSGGynecolog dialog = new RMHasilUSGGynecolog(new javax.swing.JFrame(), true);
