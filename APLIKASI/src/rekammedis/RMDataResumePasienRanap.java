...
public final class RMDataResumePasienRanap extends javax.swing.JDialog {
    ...
    private String kodekamar="",namakamar="",tglkeluar="",jamkeluar="",finger="",json,FileName = "",kodeberkas="";
    ...
    public RMDataResumePasienRanap(java.awt.Frame parent, boolean modal) {
        ...
        for (i = 0; i < 55; i++) {
            ...
            if(i==0){
                ...
                column.setPreferredWidth(150);
            }else if(i==39){ // Ini Prosedur Sekunder 3 / ICD9 Sek3
                column.setPreferredWidth(75);
            } 
            // TAMBAHKAN BLOK 'else if' UNTUK KOLOM BARU (INDEKS 40)
            else if(i==40){ // INI KOLOM BARU UNTUK TERAPI
                column.setPreferredWidth(250); // Sesuaikan lebarnya
            }
            // GESER INDEKS KOLOM BERIKUTNYA (+1)
            else if(i==41){ // sebelumnya 40 (Alergi)
                column.setPreferredWidth(150);
            }else if(i==42){ // sebelumnya 41 (Diet)
                column.setPreferredWidth(250);
            }else if(i==43){ // sebelumnya 42 (Lab Belum)
                column.setPreferredWidth(250);
            }else if(i==44){ // sebelumnya 43 (Edukasi)
                column.setPreferredWidth(250);
            }else if(i==45){ // sebelumnya 44 (Keadaan Pulang)
                column.setPreferredWidth(90);
            }else if(i==46){ // sebelumnya 45 (Ket. Keadaan)
                column.setPreferredWidth(120);
            }else if(i==47){ // sebelumnya 46 (Cara Keluar)
                column.setPreferredWidth(100);
            }else if(i==48){ // sebelumnya 47 (Ket. Cara Keluar)
                column.setPreferredWidth(120);
            }else if(i==49){ // sebelumnya 48 (Dilanjutkan)
                column.setPreferredWidth(90);
            }else if(i==50){ // sebelumnya 49 (Ket. Dilanjutkan)
                column.setPreferredWidth(120);
            }else if(i==51){ // sebelumnya 50 (Kontrol)
                column.setPreferredWidth(120);
            }else if(i==52){ // sebelumnya 51 (Obat Pulang)
                column.setPreferredWidth(250);
            }else if(i==53){ // sebelumnya 52 (Kode Bayar)
                column.setPreferredWidth(150);
            } else if(i==54){ // sebelumnya 53 (Cara Bayar)
                column.setPreferredWidth(150);
            }else{
    ...
    private void initComponents() {
        ...
        UploadBerkas = new javax.swing.JMenuItem();
        ...
        UploadBerkas.setBackground(new java.awt.Color(255, 255, 254));
        UploadBerkas.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        UploadBerkas.setForeground(new java.awt.Color(50, 50, 50));
        UploadBerkas.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        UploadBerkas.setText("Upload Berkas");
        UploadBerkas.setName("UploadBerkas"); // NOI18N
        UploadBerkas.setPreferredSize(new java.awt.Dimension(250, 26));
        UploadBerkas.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                UploadBerkasActionPerformed(evt);
            }
        });
        jPopupMenu1.add(UploadBerkas);
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(100, 1260));
        ...
        jLabel25.setBounds(0, 710, 145, 23);
        ...
        DiagnosaSekunder2.setBounds(150, 710, 520, 23);

        jLabel26.setText("Diagnosa Sekunder 3 :");
        jLabel26.setName("jLabel26"); // NOI18N
        FormInput.add(jLabel26);
        jLabel26.setBounds(0, 740, 145, 23);
        ...
        DiagnosaUtama.setBounds(150, 650, 520, 23);

        jLabel27.setText("Diagnosa Utama :");
        jLabel27.setName("jLabel27"); // NOI18N
        FormInput.add(jLabel27);
        jLabel27.setBounds(0, 650, 145, 23);
        ...
        DiagnosaSekunder3.setBounds(150, 740, 520, 23);

        jLabel28.setText("Diagnosa Sekunder 4 :");
        jLabel28.setName("jLabel28"); // NOI18N
        FormInput.add(jLabel28);
        jLabel28.setBounds(0, 770, 145, 23);
        ...
        DiagnosaSekunder4.setBounds(150, 770, 520, 23);
        ...
        jLabel29.setBounds(0, 630, 100, 23);

        jLabel30.setText("Diagnosa Sekunder 1 :");
        jLabel30.setName("jLabel30"); // NOI18N
        FormInput.add(jLabel30);
        jLabel30.setBounds(0, 680, 145, 23);
        ...
        DiagnosaSekunder1.setBounds(150, 680, 520, 23);

        jLabel31.setText("Kode ICD :");
        jLabel31.setName("jLabel31"); // NOI18N
        FormInput.add(jLabel31);
        jLabel31.setBounds(530, 630, 210, 23);
        ...
        KodeDiagnosaUtama.setBounds(710, 650, 75, 23);
        ...
        KodeDiagnosaSekunder1.setBounds(710, 680, 75, 23);
        ...
        KodeDiagnosaSekunder2.setBounds(710, 710, 75, 23);
        ...
        KodeDiagnosaSekunder3.setBounds(710, 740, 75, 23);
        ...
        KodeDiagnosaSekunder4.setBounds(710, 770, 75, 23);

        jLabel32.setText("Prosedur Utama :");
        jLabel32.setName("jLabel32"); // NOI18N
        FormInput.add(jLabel32);
        jLabel32.setBounds(0, 800, 145, 23);
        ...
        ProsedurUtama.setBounds(150, 800, 520, 23);
        ...
        KodeProsedurUtama.setBounds(710, 800, 75, 23);
        ...
        ProsedurSekunder1.setBounds(150, 830, 520, 23);

        jLabel33.setText("Prosedur Sekunder 1 :");
        jLabel33.setName("jLabel33"); // NOI18N
        FormInput.add(jLabel33);
        jLabel33.setBounds(0, 830, 145, 23);
        ...
        KodeProsedurSekunder1.setBounds(710, 830, 75, 23);

        jLabel34.setText("Prosedur Sekunder 2 :");
        jLabel34.setName("jLabel34"); // NOI18N
        FormInput.add(jLabel34);
        jLabel34.setBounds(0, 860, 145, 23);
        ...
        ProsedurSekunder2.setBounds(150, 860, 520, 23);
        ...
        KodeProsedurSekunder2.setBounds(710, 860, 75, 23);
        ...
        KodeProsedurSekunder3.setBounds(710, 890, 75, 23);
        ...
        ProsedurSekunder3.setBounds(150, 890, 520, 23);

        jLabel35.setText("Prosedur Sekunder 3 :");
        jLabel35.setName("jLabel35"); // NOI18N
        FormInput.add(jLabel35);
        jLabel35.setBounds(0, 890, 145, 23);
        ...
        jLabel37.setBounds(380, 1130, 70, 23);
        ...
        CaraKeluar.setBounds(460, 1130, 205, 23);

        jLabel36.setText("Keadaan Pulang :");
        jLabel36.setName("jLabel36"); // NOI18N
        FormInput.add(jLabel36);
        jLabel36.setBounds(0, 1130, 100, 23);
        ...
        Keadaan.setBounds(110, 1130, 130, 23);
        ...
        jLabel38.setBounds(0, 920, 100, 23);
        ...
        Alergi.setBounds(110, 920, 681, 23);

        jLabel39.setText("Diet :");
        jLabel39.setName("jLabel39"); // NOI18N
        FormInput.add(jLabel39);
        jLabel39.setBounds(0, 950, 100, 23);
        ...
        KetKeluar.setBounds(660, 1130, 125, 23);

        jLabel40.setText("Hasil Lab Yang Belum Selesai (Pending) :");
        jLabel40.setName("jLabel40"); // NOI18N
        FormInput.add(jLabel40);
        jLabel40.setBounds(0, 1010, 230, 23);
        ...
        BtnDokter17.setBounds(200, 1040, 28, 23);
        ...
        scrollPane8.setBounds(110, 950, 681, 50);

        jLabel41.setText("Instruksi/Anjuran Dan Edukasi (Follow Up) :");
        jLabel41.setName("jLabel41"); // NOI18N
        FormInput.add(jLabel41);
        jLabel41.setBounds(0, 1070, 230, 23);
        ...
        scrollPane9.setBounds(240, 1070, 551, 50);
        ...
        KetKeadaanPulang.setBounds(240, 1130, 130, 23);

        jLabel42.setText("Dilanjutkan :");
        jLabel42.setName("jLabel42"); // NOI18N
        FormInput.add(jLabel42);
        jLabel42.setBounds(0, 1160, 100, 23);
        ...
        DIlanjutkan.setBounds(110, 1160, 130, 23);
        ...
        KetDilanjutkan.setBounds(240, 1160, 270, 23);

        Kontrol.setForeground(new java.awt.Color(50, 70, 50));
        Kontrol.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "06-01-2026 17:30:42" }));
        ...
        BtnDokter18.setBounds(70, 980, 28, 23);
        ...
        scrollPane10.setBounds(240, 1010, 551, 50);
        ...
        scrollPane11.setBounds(110, 1190, 681, 50);
        ...
        BtnDokter19.setBounds(70, 1220, 28, 23);
        ...
        BtnDokter21.setBounds(190, 590, 28, 23);

        jLabel14.setText("Terapi IGD :");
        jLabel14.setName("jLabel14"); // NOI18N
        FormInput.add(jLabel14);
        jLabel14.setBounds(0, 560, 220, 23);
        ...
        scrollPane13.setViewportView(Terapi);

        FormInput.add(scrollPane13);
        scrollPane13.setBounds(224, 560, 561, 50);
        ...
        BtnDokter22.setBounds(100, 630, 28, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().equals("")||TNoRM.getText().equals("")||TPasien.getText().equals("")){
            ...
            if(Sequel.menyimpantf("resume_pasien_ranap","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",42,new String[]{
                ...
                Terapi.getText(), // <-- TAMBAHKAN Terapi.getText() DI SINI
                ...
                // Bagian tabMode.addRow perlu disesuaikan juga
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReportqry("rptDataResumePasienRanap.jasper","report","::[ Data Resume Pasien ]::",
                    ...
                    "resume_pasien_ranap.prosedur_sekunder2,resume_pasien_ranap.kd_prosedur_sekunder2,resume_pasien_ranap.prosedur_sekunder3,resume_pasien_ranap.kd_prosedur_sekunder3,resume_pasien_ranap.terapi,resume_pasien_ranap.alergi,"+ 
    ...
    private void KodeProsedurSekunder3KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KodeProsedurSekunder3KeyPressed
        Valid.pindah(evt,ProsedurSekunder3,Terapi);
            ...
            carikeluhan.addWindowListener(new WindowListener() {
                ...
                public void windowClosed(WindowEvent e) {
                    if(carikeluhan.getTable().getSelectedRow()!= -1){
                        // PERUBAHAN DI SINI: dari .append() menjadi .setText()
                        KeluhanUtama.setText(carikeluhan.getTable().getValueAt(carikeluhan.getTable().getSelectedRow(),2).toString());
            ...
            caripemeriksaan.addWindowListener(new WindowListener() {
                ...
                public void windowClosed(WindowEvent e) {
                    if(caripemeriksaan.getTable().getSelectedRow()!= -1){
                        // PERUBAHAN DI SINI: dari .append() menjadi .setText()
                        PemeriksaanFisik.setText(caripemeriksaan.getTable().getValueAt(caripemeriksaan.getTable().getSelectedRow(),2).toString());
    ...
    private void BtnDokter20ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnDokter20ActionPerformed
        if(TNoRw.getText().equals("")&&TNoRM.getText().equals("")){
            ...
            RMCariInstruksi cariinstruksi=new RMCariInstruksi(null,false);
            cariinstruksi.getTable().addKeyListener(new KeyListener() {
                @Override
                public void keyTyped(KeyEvent e) {}
                @Override
                public void keyPressed(KeyEvent e) {
                    if(e.getKeyCode()==KeyEvent.VK_SPACE){
                        e.consume(); 
                        StringBuilder dataTerpilih = new StringBuilder();
                        for (i= 0; i < cariinstruksi.getTable().getRowCount(); i++) {
                            if(cariinstruksi.getTable().getValueAt(i,0) != null && 
                               cariinstruksi.getTable().getValueAt(i,0).toString().equals("true")){
                                if(dataTerpilih.length() > 0){
                                    dataTerpilih.append("\n");
                                }
                                dataTerpilih.append(cariinstruksi.getTable().getValueAt(i,3).toString());
                            }
                        }
                        if(dataTerpilih.length() > 0) {
                            ObatSelamaDiRS.setText(dataTerpilih.toString());
                        }
                    ObatSelamaDiRS.requestFocus();
                        cariinstruksi.dispose();
                    }
                }
                @Override
                public void keyReleased(KeyEvent e) {}
            });
            cariinstruksi.setNoRawat(TNoRw.getText());
            cariinstruksi.tampil();
            cariinstruksi.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
            cariinstruksi.setLocationRelativeTo(internalFrame1);
            cariinstruksi.setVisible(true);
        }
    ...
    private void BtnDokter21ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnDokter21ActionPerformed
        if(TNoRw.getText().equals("")&&TNoRM.getText().equals("")){
            ...
            RMCariTerapi cariterapi = new RMCariTerapi(null,false);

            cariterapi.addWindowListener(new java.awt.event.WindowListener() {
                @Override
                ...
                public void windowClosed(java.awt.event.WindowEvent e) {
                    if(cariterapi.getTable().getSelectedRow()!= -1){
                        String dataBaru = cariterapi.getTable().getValueAt(cariterapi.getTable().getSelectedRow(), 2).toString();
                        
                        // PERUBAHAN DISINI: Menggunakan setText untuk MENGGANTI isinya
                        Terapi.setText(dataBaru); 
            ...
            cariterapi.setNoRawat(TNoRw.getText());
            cariterapi.tampil();
            cariterapi.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
            cariterapi.setLocationRelativeTo(internalFrame1);
            cariterapi.setVisible(true);
        }
    ...
    private void TerapiKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TerapiKeyPressed
        Valid.pindah2(evt, KodeProsedurSekunder3, Alergi);   
    ...
    private void BtnDokter22ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnDokter22ActionPerformed
        if(TNoRw.getText().equals("") && TNoRM.getText().equals("")){
            javax.swing.JOptionPane.showMessageDialog(null,"Pasien masih kosong...!!!");
        } else {
            RMCariDiagnosa1 caridiagnosa = new RMCariDiagnosa1(null, false);

            caridiagnosa.addWindowListener(new java.awt.event.WindowAdapter() {
                @Override
                public void windowClosed(java.awt.event.WindowEvent e) {
                    if (caridiagnosa.getTable().getRowCount() > 0) {
                        KodeDiagnosaUtama.setText(""); DiagnosaUtama.setText("");
                        KodeDiagnosaSekunder1.setText(""); DiagnosaSekunder1.setText("");
                        KodeDiagnosaSekunder2.setText(""); DiagnosaSekunder2.setText("");
                        KodeDiagnosaSekunder3.setText(""); DiagnosaSekunder3.setText("");
                        KodeDiagnosaSekunder4.setText(""); DiagnosaSekunder4.setText("");

                        for (int i = 0; i < caridiagnosa.getTable().getRowCount(); i++) {
                            if (Boolean.TRUE.equals(caridiagnosa.getTable().getValueAt(i, 0))) {

                                Object nilaiUrutObj = caridiagnosa.getTable().getValueAt(i, 4);
                                String kodePenyakit = (String) caridiagnosa.getTable().getValueAt(i, 1);
                                String namaPenyakit = (String) caridiagnosa.getTable().getValueAt(i, 2);

                                if(nilaiUrutObj != null && !nilaiUrutObj.toString().equals("")){
                                    String noUrut = nilaiUrutObj.toString();

                                    switch(noUrut){
                                        case "1":
                                        KodeDiagnosaUtama.setText(kodePenyakit);
                                        DiagnosaUtama.setText(namaPenyakit);
                                        break;
                                        case "2":
                                        KodeDiagnosaSekunder1.setText(kodePenyakit);
                                        DiagnosaSekunder1.setText(namaPenyakit);
                                        break;
                                        case "3":
                                        KodeDiagnosaSekunder2.setText(kodePenyakit);
                                        DiagnosaSekunder2.setText(namaPenyakit);
                                        break;
                                        case "4":
                                        KodeDiagnosaSekunder3.setText(kodePenyakit);
                                        DiagnosaSekunder3.setText(namaPenyakit);
                                        break;
                                        case "5":
                                        KodeDiagnosaSekunder4.setText(kodePenyakit);
                                        DiagnosaSekunder4.setText(namaPenyakit);
                                        break;
                                    }
                                }
                            }
            ...
            caridiagnosa.setNoRawat(TNoRw.getText());
            caridiagnosa.tampil();
    ...
    */
    ...
    private javax.swing.JMenuItem UploadBerkas;
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    tabMode.addRow(new Object[]{
                        ...
                        rs.getString("kd_prosedur_sekunder2"),rs.getString("prosedur_sekunder3"),rs.getString("kd_prosedur_sekunder3"),rs.getString("terapi"),
                        rs.getString("alergi"),rs.getString("diet"),rs.getString("lab_belum"),rs.getString("edukasi"),rs.getString("keadaan"),rs.getString("ket_keadaan"),
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            Terapi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),40).toString());
            Alergi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),41).toString()); // sebelumnya 40
            Diet.setText(tbObat.getValueAt(tbObat.getSelectedRow(),42).toString()); // sebelumnya 41
            LabBelum.setText(tbObat.getValueAt(tbObat.getSelectedRow(),43).toString()); // sebelumnya 42
            Edukasi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),44).toString()); // sebelumnya 43
            Keadaan.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),45).toString()); // sebelumnya 44
            KetKeadaanPulang.setText(tbObat.getValueAt(tbObat.getSelectedRow(),46).toString()); // sebelumnya 45
            CaraKeluar.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),47).toString()); // sebelumnya 46
            KetKeluar.setText(tbObat.getValueAt(tbObat.getSelectedRow(),48).toString()); // sebelumnya 47
            DIlanjutkan.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),49).toString()); // sebelumnya 48
            KetDilanjutkan.setText(tbObat.getValueAt(tbObat.getSelectedRow(),50).toString()); // sebelumnya 49
            Valid.SetTgl2(Kontrol,tbObat.getValueAt(tbObat.getSelectedRow(),51).toString()); // Indeks 51 adalah Kontrol
            ObatPulang.setText(tbObat.getValueAt(tbObat.getSelectedRow(),52).toString()); // sebelumnya 51
            KdPj.setText(tbObat.getValueAt(tbObat.getSelectedRow(),53).toString()); // sebelumnya 52
            CaraBayar.setText(tbObat.getValueAt(tbObat.getSelectedRow(),54).toString()); // sebelumnya 53
        }
    }
    ...
    // Method untuk mengambil terapi paling baru dari gabungan IGD, Ralan, dan Tindakan
    private void getTerapiTerbaru(String norawat) {
        PreparedStatement psTerapi = null;
        ResultSet rsTerapi = null;
        try {
            // Query UNION ALL mirip RMCariTerapi tapi tanpa filter pencarian nama (LIKE), hanya No Rawat
            // dan di LIMIT 1 untuk mengambil yang paling atas (terbaru)
            String sql = "SELECT terapi_tindakan FROM (" +
                         "   (SELECT rawat_jl_dr.tgl_perawatan, rawat_jl_dr.jam_rawat, jns_perawatan.nm_perawatan AS terapi_tindakan " +
                         ...
                         "   UNION ALL " +
                         "   (SELECT rawat_jl_pr.tgl_perawatan, rawat_jl_pr.jam_rawat, jns_perawatan.nm_perawatan AS terapi_tindakan " +
                         ...
                         "   UNION ALL " +
                         "   (SELECT rawat_jl_drpr.tgl_perawatan, rawat_jl_drpr.jam_rawat, jns_perawatan.nm_perawatan AS terapi_tindakan " +
                         ...
                         "   UNION ALL " +
                         "   (SELECT pemeriksaan_ralan.tgl_perawatan, pemeriksaan_ralan.jam_rawat, pemeriksaan_ralan.rtl AS terapi_tindakan " +
                         "    FROM pemeriksaan_ralan WHERE pemeriksaan_ralan.no_rawat = ? AND pemeriksaan_ralan.rtl <> '') " +
                         "   UNION ALL " +
                         "   (SELECT DATE(penilaian_medis_igd.tanggal) as tgl_perawatan, TIME(penilaian_medis_igd.tanggal) as jam_rawat, penilaian_medis_igd.tata as terapi_tindakan " +
                         "    FROM penilaian_medis_igd WHERE penilaian_medis_igd.no_rawat = ? AND penilaian_medis_igd.tata <> '') " +
                         ") AS gabungan " +
                         "ORDER BY tgl_perawatan DESC, jam_rawat DESC LIMIT 1";

            psTerapi = koneksi.prepareStatement(sql);
            psTerapi.setString(1, norawat);
            psTerapi.setString(2, norawat);
            psTerapi.setString(3, norawat);
            psTerapi.setString(4, norawat);
            psTerapi.setString(5, norawat);
            
            rsTerapi = psTerapi.executeQuery();
            if (rsTerapi.next()) {
                // Set text otomatis dengan data terbaru
                Terapi.setText(rsTerapi.getString("terapi_tindakan"));
            } else {
                Terapi.setText("");
            }
        } catch (Exception e) {
            System.out.println("Error getTerapiTerbaru: " + e);
        } finally {
            if (rsTerapi != null) { try { rsTerapi.close(); } catch (Exception e) {} }
            if (psTerapi != null) { try { psTerapi.close(); } catch (Exception e) {} }
        }
    }
    ...
    public void setNoRm(String norwt, Date tgl2) {
        ...
        // --- Bagian 1: Mengambil Obat/Instruksi ---
        if(Sequel.cariInteger("select count(no_rawat) from pemeriksaan_ranap where no_rawat='"+TNoRw.getText()+"' ")>0){
            ObatSelamaDiRS.setText(Sequel.cariIsi("select instruksi from pemeriksaan_ranap where no_rawat=? order by jam_rawat desc limit 1",TNoRw.getText()));
        }

        // --- Bagian 2: Memanggil Fungsi Baru untuk Terapi (IGD/Ralan/Ranap) ---
        // Ini akan mengisi kolom Terapi secara otomatis dengan data terbaru
        getTerapiTerbaru(norwt);

        // --- Bagian 3: Variabel Database untuk Data Lain ---
        PreparedStatement psIgd = null;
        ResultSet rsIgd = null;
        PreparedStatement psInstruksi = null;
        ResultSet rsInstruksi = null;
        PreparedStatement psRiwayat = null;
        ResultSet rsRiwayat = null;

        try {
            // --- A. Mengambil Data IGD (Keluhan & Fisik) ---
            psIgd = koneksi.prepareStatement(
                    "SELECT keluhan_utama, keadaan, kesadaran, gcs, tb, bb, td, nadi, rr, suhu, spo, " +
                    "kepala, mata, gigi, leher, thoraks, abdomen, genital, ekstremitas, ket_fisik " +
                    "FROM penilaian_medis_igd WHERE no_rawat = ? ORDER BY tanggal DESC LIMIT 1");
            psIgd.setString(1, norwt);
            rsIgd = psIgd.executeQuery();
            
            if (rsIgd.next()) {
                KeluhanUtama.setText(rsIgd.getString("keluhan_utama"));
                
                StringBuilder fis = new StringBuilder();
                fis.append("TD: ").append(rsIgd.getString("td")).append(" mmHg, ");
                fis.append("Nadi: ").append(rsIgd.getString("nadi")).append(" x/menit, ");
                fis.append("RR: ").append(rsIgd.getString("rr")).append(" x/menit, ");
                fis.append("Suhu: ").append(rsIgd.getString("suhu")).append(" °C, ");
                fis.append("SpO2: ").append(rsIgd.getString("spo")).append(" %, ");
                fis.append("GCS: ").append(rsIgd.getString("gcs")).append(", ");
                fis.append("TB: ").append(rsIgd.getString("tb")).append(" cm, ");
                fis.append("BB: ").append(rsIgd.getString("bb")).append(" Kg\n");
                fis.append("Keterangan Tambahan: ").append(rsIgd.getString("ket_fisik"));

                PemeriksaanFisik.setText(fis.toString());
            } else {
                 KeluhanUtama.setText("");
                 PemeriksaanFisik.setText("");
            }

            // --- B. Mengambil Riwayat Keluhan dari Ranap ---
            try {
                psRiwayat = koneksi.prepareStatement(
                    "SELECT keluhan FROM pemeriksaan_ranap WHERE no_rawat=? ORDER BY tgl_perawatan DESC, jam_rawat DESC LIMIT 1");
                psRiwayat.setString(1, norwt);
                rsRiwayat = psRiwayat.executeQuery();
                if(rsRiwayat.next()){
                    if(!rsRiwayat.getString("keluhan").trim().equals("")){
                        KeluhanUtama.setText(rsRiwayat.getString("keluhan"));
                    }
                }
            } catch (Exception e) {
                System.out.println("Notif Error Riwayat Ranap : " + e);
            }
                 
            // --- C. Mengambil Instruksi / Edukasi ---
            psInstruksi = koneksi.prepareStatement(
                    "SELECT instruksi FROM pemeriksaan_ranap WHERE no_rawat = ? ORDER BY tgl_perawatan DESC, jam_rawat DESC LIMIT 1");
            psInstruksi.setString(1, norwt);
            rsInstruksi = psInstruksi.executeQuery();
            if (rsInstruksi.next()) {
                Edukasi.setText(rsInstruksi.getString("instruksi"));
            } else {
                 Edukasi.setText("");
            }

        } catch (Exception e) {
            System.out.println("Notifikasi Error Pengambilan Data Otomatis : " + e);
        } finally {
            if (rsIgd != null) { try { rsIgd.close(); } catch (Exception e) {} }
            if (psIgd != null) { try { psIgd.close(); } catch (Exception e) {} }
            if (rsRiwayat != null) { try { rsRiwayat.close(); } catch (Exception e) {} } 
            if (psRiwayat != null) { try { psRiwayat.close(); } catch (Exception e) {} } 
            if (rsInstruksi != null) { try { rsInstruksi.close(); } catch (Exception e) {} }
            if (psInstruksi != null) { try { psInstruksi.close(); } catch (Exception e) {} }
        }
        
        DiagnosaAwal.requestFocus(); 
        
        // --- Bagian 4: Mengambil Prosedur ICD-9 ---
        try {
            ps=koneksi.prepareStatement(
    ...
    private void ganti() {
        if(Sequel.mengedittf("resume_pasien_ranap","no_rawat=?","no_rawat=?,kd_dokter=?,diagnosa_awal=?,alasan=?,keluhan_utama=?,pemeriksaan_fisik=?,jalannya_penyakit=?,pemeriksaan_penunjang=?,"+
            ...
            "prosedur_sekunder2=?,kd_prosedur_sekunder2=?,prosedur_sekunder3=?,kd_prosedur_sekunder3=?,terapi=?,alergi=?,diet=?,lab_belum=?,edukasi=?,cara_keluar=?,ket_keluar=?,keadaan=?,"+ 
            "ket_keadaan=?,dilanjutkan=?,ket_dilanjutkan=?,kontrol=?,obat_pulang=?",43,new String[]{ // <-- Ubah ke 43
            TNoRw.getText(),KodeDokter.getText(),DiagnosaAwal.getText(),Alasan.getText(),KeluhanUtama.getText(),PemeriksaanFisik.getText(),JalannyaPenyakit.getText(),
            PemeriksaanRad.getText(),HasilLaborat.getText(),TindakanSelamaDiRS.getText(),ObatSelamaDiRS.getText(),DiagnosaUtama.getText(),KodeDiagnosaUtama.getText(),
            DiagnosaSekunder1.getText(),KodeDiagnosaSekunder1.getText(),DiagnosaSekunder2.getText(),KodeDiagnosaSekunder2.getText(),DiagnosaSekunder3.getText(),
            KodeDiagnosaSekunder3.getText(),DiagnosaSekunder4.getText(),KodeDiagnosaSekunder4.getText(),ProsedurUtama.getText(),KodeProsedurUtama.getText(),
            ...
            Keadaan.getSelectedItem().toString(),KetKeadaanPulang.getText(),DIlanjutkan.getSelectedItem().toString(),KetDilanjutkan.getText(),
            Valid.SetTgl(Kontrol.getSelectedItem()+"")+" "+Kontrol.getSelectedItem().toString().substring(11,19),ObatPulang.getText(),
            tbObat.getValueAt(tbObat.getSelectedRow(),0).toString() // Kondisi WHERE
            })==true){
                   ...
                   tbObat.setValueAt(Terapi.getText(),tbObat.getSelectedRow(),40);
                   tbObat.setValueAt(Alergi.getText(),tbObat.getSelectedRow(),41); // sebelumnya 40
                   tbObat.setValueAt(Diet.getText(),tbObat.getSelectedRow(),42); // sebelumnya 41
                   tbObat.setValueAt(LabBelum.getText(),tbObat.getSelectedRow(),43); // sebelumnya 42
                   tbObat.setValueAt(Edukasi.getText(),tbObat.getSelectedRow(),44); // sebelumnya 43
                   tbObat.setValueAt(Keadaan.getSelectedItem().toString(),tbObat.getSelectedRow(),45); // sebelumnya 44
                   tbObat.setValueAt(KetKeadaanPulang.getText(),tbObat.getSelectedRow(),46); // sebelumnya 45
                   tbObat.setValueAt(CaraKeluar.getSelectedItem().toString(),tbObat.getSelectedRow(),47); // sebelumnya 46
                   tbObat.setValueAt(KetKeluar.getText(),tbObat.getSelectedRow(),48); // sebelumnya 47
                   tbObat.setValueAt(DIlanjutkan.getSelectedItem().toString(),tbObat.getSelectedRow(),49); // sebelumnya 48
                   tbObat.setValueAt(KetDilanjutkan.getText(),tbObat.getSelectedRow(),50); // sebelumnya 49
                   tbObat.setValueAt(Valid.SetTgl(Kontrol.getSelectedItem()+"")+" "+Kontrol.getSelectedItem().toString().substring(11,19),tbObat.getSelectedRow(),51); // sebelumnya 50
                   tbObat.setValueAt(ObatPulang.getText(),tbObat.getSelectedRow(),52); // sebelumnya 51
                   tbObat.setValueAt(KdPj.getText(),tbObat.getSelectedRow(),53); // sebelumnya 52
                   tbObat.setValueAt(CaraBayar.getText(),tbObat.getSelectedRow(),54); // sebelumnya 53
                   emptTeks();
            }
    }
    ...
    private void UploadPDF(String FileName, String docpath) {
        try {
            ...
            org.apache.http.client.methods.HttpPost postRequest = new org.apache.http.client.methods.HttpPost("http://" + koneksiDB.HOSTHYBRIDWEB() + ":" + koneksiDB.PORTWEB() + "/" + koneksiDB.HYBRIDWEB() + "/upload.php?doc=" + docpath);
            ...
            kodeberkas = Sequel.cariIsi("SELECT kode FROM master_berkas_digital WHERE nama LIKE '%RESUME%'");
