...
public final class RMDataResumePasien extends javax.swing.JDialog {
    ...
    */
    ...
    public void setNoRm(String norwt, Date tgl2) {
        ...
        Keluhan.setText(Sequel.cariIsi("select keluhan from pemeriksaan_ralan where no_rawat=? order by jam_rawat desc limit 1",TNoRw.getText()));
        JalannyaPenyakit.setText(Sequel.cariIsi("select pemeriksaan from pemeriksaan_ralan where no_rawat=? order by jam_rawat desc limit 1",TNoRw.getText()));
        DiagnosaUtama.setText(Sequel.cariIsi("select penilaian from pemeriksaan_ralan where no_rawat=? order by jam_rawat desc limit 1",TNoRw.getText()));
        }else{
        }
